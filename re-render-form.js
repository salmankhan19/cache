...
async function startProcess() {
  ...
  async function checkAppointmentsAvailable() {
    ...
    if (isAvailable) {
      ...
      await page.goto(
        "        https://service2.diplo.de/rktermin/extern/appointment_showForm.do?locationCode=kara&realmId=967&categoryId=2801&dateStr=09.01.2025&openingPeriodId=68493",
        { waitUntil: "domcontentloaded" }
      );
